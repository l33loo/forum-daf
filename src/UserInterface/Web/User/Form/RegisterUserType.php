 ...
 */
final class RegisterUserType extends AbstractType implements DataMapperInterface
{
    ...
    {
        if (!$viewData instanceof RegisterUserCommand) {
            return;
        }
    ...
    public function mapFormsToData(Traversable $forms, mixed &$viewData): void
    {
        /** @var FormInterface[] $forms */
        $forms = iterator_to_array($forms);
        $viewData = new RegisterUserCommand(
